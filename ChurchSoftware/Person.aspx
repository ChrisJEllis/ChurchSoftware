<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Person.aspx.cs" Inherits="ChurchSoftware.Person" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvAttendanceReport" runat="server" 
        DataKeyNames="PersonId" OnRowEditing="gvAttendanceReport_RowEditing">
        <Columns>
